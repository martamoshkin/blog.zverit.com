...
- Для заказчика, привлечение профессионалов на отдельные работы, без найма в штат.
...
- Для исполнителя, гарантированная загрузка и оплата команды на определенный промежуток времени.
- Для исполнителя, большой чек за минимальные действия.

#### Недостатки:

- Для заказчика, очень дорого, если заранее оплаченное количество времени и ресурсов не используется в полной мере.
- Для исполнителя, сложность поиска “большого” клиента под **Retainer**.
