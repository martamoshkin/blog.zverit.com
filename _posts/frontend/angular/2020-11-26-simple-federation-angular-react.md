...
` React.createElement(component.default)` — непосредственное применение полученного удаленного модуля.
